...
class LightGCNEmbedding(GraphEmbedding):
    def __init__(self, node_features, edge_features, memory, neighbor_finder, time_encoder, n_layers,
                 n_node_features, n_edge_features, n_time_features, embedding_dimension, device,
                 n_heads=2, dropout=0.1, use_memory=True):
        super(LightGCNEmbedding, self).__init__(node_features=node_features,
                                                edge_features=edge_features,
                                                memory=memory,
                                                neighbor_finder=neighbor_finder,
                                                time_encoder=time_encoder, n_layers=n_layers,
    ...
    def aggregate(self, n_layer, source_node_features, source_nodes_time_embedding,
        ...
        # Simple sum of the neighbor embeddings
        sum_embeddings = torch.sum(neighbor_embeddings, dim=1)
        
        return sum_embeddings
      
class UltraGCNEmbedding(GraphEmbedding):
    def __init__(self, node_features, edge_features, memory, neighbor_finder, time_encoder, n_layers,
                 n_node_features, n_edge_features, n_time_features, embedding_dimension, device,
                 n_heads=2, dropout=0.1, use_memory=True):
        super(UltraGCNEmbedding, self).__init__(node_features=node_features,
                                                edge_features=edge_features,
                                                memory=memory,
                                                neighbor_finder=neighbor_finder,
                                                time_encoder=time_encoder, n_layers=n_layers,
    ...
    def aggregate(self, n_layer, source_node_features, source_nodes_time_embedding,
        ...
        sum_neighbors = torch.sum(neighbor_embeddings, dim=1)
        
        # Sum of source node feature and its neighbors
        aggregated_embeddings = sum_neighbors + source_node_features
...
def get_embedding_module(module_type, node_features, edge_features, memory, neighbor_finder,
  ...
  elif module_type == 'graph_LightGCN':
    return LightGCNEmbedding(node_features=node_features,
                                  edge_features=edge_features,
                                  memory=memory,
                                  neighbor_finder=neighbor_finder,
                                  time_encoder=time_encoder,
  ...
  elif module_type == 'graph_UltraGCN':
    return UltraGCNEmbedding(node_features=node_features,
                                  edge_features=edge_features,
                                  memory=memory,
                                  neighbor_finder=neighbor_finder,
                                  time_encoder=time_encoder,
